import {
  ...
  Film, Sparkles, Type, Smartphone, Palette, Star as StarIcon, Music,
  Mail, ShieldX,
} from "lucide-react";
...
const allTools: ToolDef[] = [
  ...
  { id: "pdf-compressor", title: "PDF Compressor", description: "Reduce PDF file size.", icon: Minimize2, route: "/pdf-compressor", category: "pdf", phase: 4, available: false },
  { id: "pdf-compare", title: "PDF Compare", description: "Side-by-side diff of two PDFs.", icon: Scale, route: "/pdf-compare", category: "pdf", phase: 4, available: false },
  { id: "pdf-redaction", title: "PDF Redaction", description: "Permanently black out content.", icon: EyeOff, route: "/pdf-redaction", category: "pdf", phase: 4, available: false },
  { id: "pdf-signature", title: "PDF Signature", description: "Draw or upload signatures.", icon: PenTool, route: "/pdf-signature", category: "pdf", phase: 4, available: false },
  { id: "pdf-image-extractor", title: "PDF Image Extractor", description: "Extract embedded images.", icon: ImageDown, route: "/pdf-image-extractor", category: "pdf", phase: 4, available: false },
  ...
  { id: "glitch-art", title: "Glitch Art Generator", description: "Create retro glitch effects.", icon: Sparkles, route: "/glitch-art", category: "image", phase: 4, available: false },
  ...
  { id: "fake-screenshot", title: "Fake Screenshot", description: "Create social post mockups.", icon: Smartphone, route: "/fake-screenshot", category: "image", phase: 4, available: false },
  ...
  { id: "pomodoro-timer", title: "Pomodoro Timer", description: "Focus timer with work & break sessions.", icon: Timer, route: "/pomodoro-timer", category: "productivity", phase: 3, available: true },
  { id: "unit-converter", title: "Unit Converter", description: "Convert length, weight, temperature & more.", icon: Ruler, route: "/unit-converter", category: "productivity", phase: 3, available: true },
  { id: "word-counter", title: "Word Counter", description: "Words, characters, reading time & more.", icon: LetterText, route: "/word-counter", category: "productivity", phase: 3, available: true },
